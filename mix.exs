defmodule UnicornEncourager.Mixfile do
  use Mix.Project
  ...
  # invoke UnicornEncourager.start/2 when running on a target.
  def application("host") do
    [extra_applications: [:logger]]
  end

  def application(_target) do
    [mod: {UnicornEncourager.Application, []},
     extra_applications: [:logger, :nerves_neopixel]]
  end
  ...
  def deps(target) do
    [
      ...
      {:nerves_neopixel, github: "GregMefford/nerves_neopixel", branch: "master"}
    ] ++ system(target)
  end
